...
def get_data():
  processed_videos_path = "files/processed_videos_palestine.csv"
  comments_info_path = "files/comments_info_palestine.csv"
  channels_info_path = "files/channels_info_palestine.csv"
  videos_info_path = "files/videos_info_palestine.csv"
